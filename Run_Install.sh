...
if [ $arg == "Ghost" ]; then
  sudo chmod +x /usr/local/bin/NanoBite--Installer/pkgs/Ghost/NanoBite-get--install.sh
  sudo /usr/local/bin/NanoBite--Installer/pkgs/Ghost/NanoBite-get--install.sh
else
